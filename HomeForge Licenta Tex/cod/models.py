...
class DeviceControl(models.Model):
    ...
    # Planned for future implementation, not yet wired to firmware.
    FUTURE_WIDGET_TYPES = [
        WIDGET_MOTION,
        WIDGET_CO2,
        WIDGET_LIGHT,
    ...
    unit = models.CharField(max_length=20, null=True, blank=True, help_text="Display unit (e.g.,  degC, %, lux, ppm)")
