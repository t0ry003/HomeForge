...
const SENSOR_WIDGET_TYPES = [
  { type: 'TEMPERATURE' as WidgetType, icon: Thermometer, label: 'Temperature', defaultLabel: 'Temperature', category: 'sensor', unit: ' degC' },
        ...
        <>
          <div className="flex items-baseline">
            ...
            <span className="text-xs text-muted-foreground ml-0.5">
              {widget.unit || (widget.type === 'TEMPERATURE' ? ' degC' : widget.type === 'HUMIDITY' ? '%' : widget.type === 'LIGHT' ? 'lux' : 'ppm')}
            </span>
          </div>
    ...
    >
      ...
      <div className="flex items-center justify-between gap-3 pl-6">
        ...
        <div className="shrink-0">
          ...
          {widget.type === 'TEMPERATURE' && <span className="text-sm font-bold text-orange-500">23.5 degC</span>}
