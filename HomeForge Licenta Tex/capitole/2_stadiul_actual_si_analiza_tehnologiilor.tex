...
Alegerile tehnologice nu sunt accidentale. Fiecare componentă rezolvă o problemă concretă, întâlnită în implementare. Mai jos justific principalele opțiuni, care se vor regăsi în capitolele următoare.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figuri/stiva_tehnologica.pdf}
