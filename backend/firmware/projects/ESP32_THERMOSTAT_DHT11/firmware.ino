/*
 * HomeForge - ESP32 Thermostat: DHT11 (Auto-Discovery)
 * ----------------------------------------------------
 * Reads temperature & humidity (DHT11) and publishes them to HomeForge over MQTT.
 *
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    String clientId = "ESP32-DHT11-" + deviceMac;
