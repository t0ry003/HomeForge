/*
 * HomeForge - ESP32 Thermostat: DHT11 + BMP180 (Auto-Discovery)
 * -------------------------------------------------------------
 * Reads temperature & humidity (DHT11) and barometric pressure (BMP180)
 * and publishes them to HomeForge over MQTT.
 *
...
// DHT11 reads with a tolerance of +/- 2 degrees Celsius.
float DHT11_ERROR = -2;
...
void readSensors() {
  ...
  if (!isnan(newT) && !isnan(newH)) {
    humidity = newH;
    // Apply the DHT11 tolerance correction.
